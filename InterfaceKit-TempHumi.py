...
def filewrite(datavalues):
    ...
    if os.path.isfile(PATH):
        file_object=open("/home/pi/Desktop/Python/"+filename, "a")
    else:
        file_object=open("/home/pi/Desktop/Python/"+filename, "w")
    for i in datavalues.items():
        if i[0]== 0:
            ...
            if i[0] == 2:
                file_object.write("Soil Moisture " + str(i[1])+"\n")
